...
namespace CheckConsraints.DAL
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Birinci Parametre Consraint ismi , ikinci parametre sql cumleciğimiz olacaktır.
            // Aşağıdaki Consraint ile Price alanının DiscountPrice alanından her zaman buyuk olacagını DB duzeyinde garanti altına almıs olduk.
