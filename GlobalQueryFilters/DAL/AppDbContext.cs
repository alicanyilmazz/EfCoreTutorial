...
namespace GlobalQueryFilters.DAL
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //Product tablosundaki "IsDeleted" Column ın default olarak "False" degerini set ettik.
            modelBuilder.Entity<Product>().Property(x => x.IsDeleted).HasDefaultValue(false);


            modelBuilder.Entity<Product>().HasQueryFilter(p => !p.IsDeleted); // Aşağıdaki ile birebir aynıdır.
