...
using ToViewMethod.Model;

namespace ToViewMethod.DAL
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<ProductWhole> ProductWhole { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductWhole>().HasNoKey().ToView("productwithfeatures");
