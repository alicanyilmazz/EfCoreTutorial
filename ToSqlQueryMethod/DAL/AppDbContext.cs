...
using ToSqlQueryMethod.DAL.Model;

namespace ToSqlQueryMethod.DAL
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductEssential>().HasNoKey(); // Bu bir Custom sorgu oldugundan EFCore PrimaryKey olmadıgı için hata vermesin diye EFCore PrimaryKey i olmadıgını bildiriyorum.
            modelBuilder.Entity<ProductEssential>().ToSqlQuery("Select Name,Price From Products");
